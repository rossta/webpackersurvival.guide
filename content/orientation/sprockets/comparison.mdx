...
Here's a great example the highlights the differences between Webpacker and Sprockets. In Webpacker, the strategy is a bit more complex and explicit while the Sprockets approach is simpler and "just works."
