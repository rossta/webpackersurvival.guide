  ...
  <Layout>
    <div class="pt-8 md:pt-16">
      ...
      <div class="flex flex-wrap justify-center -mx-4">
        <div class="flex flex-col items-center w-full pl-8 pr-4 mb-8 text-center md:w-1/3">
        ...
        <div class="flex flex-col items-center w-full pl-4 px-8 mb-8 text-center md:w-1/3">
